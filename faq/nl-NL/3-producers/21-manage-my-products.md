...
## Wat garandeert de kwaliteit van de gegevens in Open Food Facts?
...
Om producten aan ons platform toe te voegen, moet u eerst beslissen hoe u te werk wilt gaan. Er zijn 4 opties:

- **Handmatig**: als u een klein aantal producten heeft, is het nog steeds mogelijk om elk productblad handmatig aan te maken op het Pro-platform.

- **Via een spreadsheetimport**: u kunt de spreadsheet [sjabloon](https://world.pro.openfoodfacts.org/cgi/generate_sample_import_file.pl) van Open Food Facts downloaden, of rechtstreeks een extractie vanuit uw IT-systeem importeren in het Pro-platform.
...
## Is het aantal toegevoegde producten beperkt?

Er is geen limiet, u kunt zoveel producten uploaden als u wilt op ons platform.

---

## Is het mogelijk producten te verwijderen die niet meer verkocht worden?

Als u een product wilt verwijderen dat niet langer verkrijgbaar is, hoeft u alleen maar het vakje "dit product wordt niet meer verkocht" aan te vinken wanneer u het productoverzicht bewerkt.

Als u meerdere producten wilt verwijderen, raden we u aan de procedure te volgen die wordt beschreven in de [gebruikershandleiding](https://blog.openfoodfacts.org/en/EN-Pro-Platform-User-Guide.pdf), op pagina 18.
...
## Heeft bedrijfsinformatie voorrang op informatie die al op het platform aanwezig is?

Wanneer een producent een van zijn producten online plaatst via zijn producentenaccount en er al een productblad bestaat, wordt dit voltooid.

De informatie die de producent heeft geplaatst, heeft altijd voorrang en alleen hij kan zijn producten aanpassen zodra de informatie is ingevuld.

Als de via het platform verzonden gegevens gefragmenteerd zijn, kan de informatie die de community via de verpakking toevoegt, deze aanvullen.

---

## In welk formaat moet ik mijn gegevens versturen?
...
## Hoe lang duurt het voordat producentengegevens worden bijgewerkt in andere apps die de Open Food Facts-database hergebruiken?

Dat hangt af van de apps. Voor degenen die onze API's gebruiken, en dat is de overgrote meerderheid, is het direct.  
Voor degenen die onze dagelijkse exports gebruiken, is het D+1, mits ze deze bijwerken.
