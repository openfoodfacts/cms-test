...
{{< fa "vraagcirkel" size=3x >}}

## Wat is het verschil met andere websites, diensten en mobiele toepassingen die al informatie over levensmiddelen kunnen beschikbaar maken?

Het belangrijkste verschil is voor ons een kritisch verschil: onze gegevens zijn vrij beschikbaar voor iedereen en voor alle toepassingen. Het zijn zogenaamde open data.

Bijna alle andere sites, diensten en toepassingen verbieden anderen hun gegevens te reproductien en te hergebruiken. Integendeel, ze houden het angstvallig voor zichzelf. In vrijwel alle gevallen verbieden hun gebruiksvoorwaarden expliciet elk niet-persoonlijk gebruik en elke extractie van alle gegevens of delen van de gegevens.

We zijn van mening dat informatie over voedselproducten te belangrijk en te nuttig is om deze in een kluis te bewaren. Toen we in 2012 het Open Food Facts-project en de bijbehorende mobiele app startten, besloten we juist het tegenovergestelde te doen: we staan niet alleen het gebruik en hergebruik van onze database gratis en kosteloos toe aan iedereen en voor alle doeleinden (inclusief commerciële), maar we moedigen het zelfs aan!
...
Bijdragers zijn vrijwilligers. Hun bijdragen worden verzameld in een open database die door iedereen en voor alle toepassingen kan worden gebruikt. (zie de [Gebruiksvoorwaarden](https://en.openfoodfacts.org/terms-of-use#reuse))

Iedereen (inclusief, maar niet beperkt tot, bijdragers en makers van Open Food Facts) kan de gegevens dus herverdelen en/of hergebruiken om websites, diensten, software, mobiele applicaties te bouwen of om artikelen en studies te schrijven. Het staat hen vrij om het werk vrij beschikbaar te maken, of om het te verkopen of om geld te verdienen (bv.. met advertenties), mits ze voldoen aan de voorwaarden voor hergebruik.
...
## Kan ik productafbeeldingen of gegevens toevoegen van de site, winkelsites of andere websites van de fabrikant?

Waarschijnlijk niet. Bijna alle andere sites verbieden reproductie en hergebruik van hun gegevens en afbeeldingen, en dat is eigenlijk de reden waarom we Open Food Facts hebben gemaakt: om al deze gegevens voor iedereen en voor alle gebruikers beschikbaar te maken.

Om elk juridisch probleem te vermijden vragen wij de bijdragers alleen maar foto's toe te voegen die zij zelf hebben genomen, en alleen gegevens toe te voegen die afkomstig zijn uit de verpakking en het etiket.
...
Let op: [Open Food Facts is een gezamenlijke database van voedingsproducten](https://world.openfoodfacts.org/discover), wij verkopen geen producten en hebben geen banden met de producenten ervan. Voor een vraag of een klacht over een product moet je rechtstreeks naar de producent schrijven (adres op het etiket van het product).

---

## Zijn de informatie en gegevens over producten geverifieerd?

De informatie en gegevens worden aangeleverd door de bijdragers van Open Food Facts. De bijdragers sturen ook foto's van het product, de labels, ingrediëntenlijsten en voedingswaardentabel. Wanneer er twijfel over bestaat, kunnen bezoekers de nauwkeurigheid zelf controleren en als er een fout is, kunnen ze het ter plaatse corrigeren.

Om potentiële fouten gemakkelijker te kunnen opsporen, zullen we geleidelijk automatische controles toevoegen. Als bijvoorbeeld de voedingswaarden van een product sterk afwijken van die van producten in dezelfde categorie, kan er sprake zijn van een fout. Als de voedingsstoffen optellen tot meer dan 100%, is het zeker een fout.
...
## Ik ben een fabrikant van levensmiddelen, kan ik mijn eigen producten toevoegen?

Ja! De enige voorwaarde is dat de gegevens en de beelden onder een open licentie beschikbaar worden gesteld. (zie de [Bijdragevoorwaarden](https://en.openfoodfacts.org/terms-of-use#contribution))
...
Als u geen antwoord op uw vraag/vragen kunt vinden, neem dan gerust contact met ons op via:

- Onze Slack: [https://slack.openfoodfacts.org/](https://slack.openfoodfacts.org/)

- Ons forum: [https://forum.openfoodfacts.org/](https://forum.openfoodfacts.org/)
