...
## ¿Hay alguna forma de eliminar las imágenes subidas para los productos?

Sólo los moderadores pueden eliminar fotos, para evitar posibles actos vandálicos.  

  

Sólo tienes que pedir en Slack o en** contact@openfoodfacts.org **para eliminar los duplicados o cualquier fotos inapropiadas (usted debe tratar de proporcionar el número de código de barras o URL para así).

También tenemos una nueva API de informe de imágenes si eres programador.

---

## Soy diseñador. ¿En qué puedo ayudarle?

Coordinamos todas las actividades relacionadas con el diseño en [https://github.com/openfoodfacts/openfoodfacts-design](https://github.com/openfoodfacts/openfoodfacts-design) y en un canal de chat específico. Periódicamente celebramos reuniones de equipo y brainjams sobre retos específicos.

---

## En algunos casos, el mismo producto puede tener valores nutricionales diferentes para cada país, ¿cómo se gestiona esto en Open Food Facts?
