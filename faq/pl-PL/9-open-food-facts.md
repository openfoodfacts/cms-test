...
Główna i zasadnicza różnica u nas: nasze dane są swobodnie dostępne dla wszystkich i do wszystkich zastosowań. Nazywa się to otwartymi danymi.

Prawie wszystkie inne strony, usługi i aplikacje zabraniają innym powielania i ponownego wykorzystywania ich danych. Quite to the contrary, the jealously keep it for themselves. In almost all cases, their terms of service explicitly forbid any non-personal use and any extraction of all the data or parts of the data.
...
Kontrybutorzy są wolontariuszami. Ich wkład jest zbierany w otwartej bazie danych, która może być wykorzystana przez każdego w dowolnym celu. (see the [Terms of reuse](https://en.openfoodfacts.org/terms-of-use#reuse))

Everyone (including but not limited to Open Food Facts contributors and creators) can thus redistribute and/or reuse the data to build web sites, services, software, mobile applications, or to write articles and studies. Są one darmowe, aby w rezultacie były one wolno dostępne lub w sprzedaży i monetyzacji (np. z reklamami), tak długo, jak respektowane są warunki użycia.
...
Tak! The only condition is to accept that the data and the pictures be made available under an open licence. (see the <a href="http://en.openbeautyfacts.org/terms-of-use#contribution">Terms of contribution</a>) (patrz <a href="https://en.openfoodfacts.org/terms-of-use#contribution">Warunki udziału</a>)

Aby uniknąć problemów prawnych, prosimy autorów o dodawanie wyłącznie zdjęć, które sami wykonali, oraz wyłącznie danych pochodzących z opakowania i etykiety produktu.
...
Aby łatwiej wykrywać potencjalne błędy, będziemy stopniowo dodawać automatyczne kontrole. e.g. if the nutrition facts of a product are very different from products of the same category, it may be an error. Jeśli suma składników odżywczych przekracza 100%, jest to zdecydowanie błąd.

Wreszcie wielu producentów przesyła nam zdjęcia i dane o swoich produktach za pośrednictwem naszej Platformy dla Producentów. If you are a producer, please [contact us](mailto:producers@openfoodfacts.org)
...
We have developped a free platform to let you easily import photos and data about your products, regardless of your size. Umożliwi importowanie kompletnych i aktualnych danych i wizualizacji do Open Food Facts, które będą widoczne w ponad 100 innych aplikacjach żywieniowych. Additionaly, the platform provides suggestions to improve the Nutri-Score of your products. Contact-us to discuss how we could proceed: [producers@openfoodfacts.org](mailto:producers@openfoodfacts.org)
