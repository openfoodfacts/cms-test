...
The information and data is submited by the Open Food Facts contributors. Bidragsyterne sender også inn bilder av produktet, etikettene, ingredienslistene og ernæringstabeller. When in doubt, visitors can thus check the accuracy by themselves, and if there is an error, they can correct it on the spot.
