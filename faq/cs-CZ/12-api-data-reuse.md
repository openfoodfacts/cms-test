...
To může záviset na zemi, zda je síť pomalá nebo drahá. cokoli nad 5000 pixelů na šířku nebo výšku pravděpodobně není příliš užitečné. a pokud nějakým způsobem dokážete zjistit, že síť je pomalá, pak by i obrázek s 2000 pixely byl skvělý (rozhodně lepší než žádný obrázek!)
...
**Austrálie** - FSANZ - NUTTAB 2006: [https://www.foodstandards.gov.au/media/documents/FSANZ%20Conf%20PostersNUTTAB.pdf](https://www.foodstandards.gov.au/media/documents/FSANZ%20Conf%20PostersNUTTAB.pdf)
...
**Dánsko** - Dánská databáze složení potravin: [https://frida.fooddata.dk/?lang=en](https://frida.fooddata.dk/?lang=en)
...
**Francie** - CIQUAL: [https://www.anses.fr/en/search/site/tabulka%20ciqual](https://www.anses.fr/en/search/site/Table%20ciqual)

-

**Německo** - Souci-Fachmann-Kraut Online Database: [https://www.sfk.online/#/home](https://www.sfk.online/#/home) nebo oficiální německá databáze: Bundeslebensmittelschlu<unk> ssel: [https://blsdb.de/](https://blsdb.de/)
...
- Na našich datech:[ https://world.openfoodfacts.org/data](https://world.openfoodfacts.org/data)
...
- Pro každý koncový bod API jsou vynuceny limity rychlosti.
...
Podobně lze použít parametr rev s API:
