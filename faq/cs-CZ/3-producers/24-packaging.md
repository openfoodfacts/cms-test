...
Jako výrobce je nejefektivnějším způsobem, jak přidat data o balení k vašim produktům, vyplnění této [excelovské tabulky](https://world.pro.openfoodfacts.org/cgi/generate_sample_import_file.pl) potřebnými informacemi ze sloupce „AU“.

Pro každou součást balení budete muset zadat:
...
- Pokyny k recyklaci (např.: **recyklovat, zlikvidovat atd.**)

- Hmotnost jedné prázdné jednotky (v g)

- Čisté množství produktu obsaženého v jednotce

Tuto tabulku lze poté importovat do naší platformy určené pro profesionály.

---

## Co je projekt Tackling Food Packaging?
