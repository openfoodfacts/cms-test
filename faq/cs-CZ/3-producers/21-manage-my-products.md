...
4. Díky podpoře Santé Publique France jsme vyvinuli portál, který umožňuje producentům nahrávat svá hromadně produkovaná data a tím opravovat/doplňovat příspěvky komunity.

---

## Jak přidat produkty?

Chcete-li přidat produkty na naši platformu, musíte se nejprve rozhodnout, jak chcete postupovat. Existují 4 možnosti:
...
- **Prostřednictvím přizpůsobeného propojení** mezi vaší společností a Open Food Facts. Pokud ve svém portfoliu máte více než 1000 produktů, můžeme prodiskutovat možnost vytvoření specifického konektoru pro usnadnění přenosu dat.
...
## Existuje způsob, jak automatizovat aktualizace produktů do veřejné databáze?

Ano, pokud používáte produktové katalogy EQUADIS, AGENA3000 nebo BAYARD a nastavíte správnou konfiguraci, import lze provést automaticky a aktualizovat tak data o produktech na Open Food Facts.

→ Pro více informací si prosím stáhněte naši [uživatelskou příručku](https://blog.openfoodfacts.org/en/EN-Pro-Plateform-User-Guide.pdf) a/nebo si prohlédněte naše [video tutoriály](https://www.youtube.com/playlist?list=PLjAH-USadsF3xgSVfUUBS4we3XBr-1r55) :-)

---

## Je počet přidaných produktů omezený?

Neexistuje žádný limit, na naši platformu můžete nahrát libovolný počet produktů.

---

## Je možné smazat produkty, které se již neprodávají?

Pokud chcete odstranit produkt, který již není na trhu k dispozici, stačí při úpravě produktového listu zaškrtnout políčko „tento produkt se již neprodává“.

Pokud chcete odstranit několik produktů, doporučujeme postupovat podle postupu uvedeného v [uživatelské příručce](https://blog.openfoodfacts.org/en/EN-Pro-Platform-User-Guide.pdf) na str. 18.

V případě jakýchkoli dotazů nás můžete také kontaktovat na adrese producers@openfoodfacts.org.

Po archivaci se produkt již nebude zobrazovat v Open Food Facts.Zůstane však v naší databázi, abychom mohli uchovávat historii prodaných produktů v průběhu času.
...
## V jakém formátu mám odeslat svá data?
...
Kromě importu z EQUADIS nebo AGENA3000 můžete také importovat soubor Excel, pokud data ještě nejsou ve vašem informačním systému. V těchto případech nezapomeňte z rozhraní požádat o export do veřejné databáze.
...
## Jak přidat produkty bez čárových kódů přes platformu Pro?

U produktů bez čárového kódu, ať už na webu nebo na platformě výrobce, je v levém sloupci tlačítko „Produkt bez čárového kódu“, které umožňuje jejich přidání. Identifikátor se poté vygeneruje automaticky.

---

## Mohou být živočišné produkty, nepotravinářské produkty, kosmetika a další produkty začleněny do Open Food Facts?

Vytvořili jsme specifické projekty pro kosmetiku, krmivo pro zvířata a také pro další produkty: Open Beauty Facts, Open Pet Food Facts a Open Products Facts.
Jsme proto rádi, že můžeme importovat vaše produkty do projektu, který jim vyhovuje.
...
## Jak dlouho trvá aktualizace dat o výrobcích v jiných aplikacích, které znovu používají databázi Open Food Facts?

Záleží na aplikacích. Pro ty, kteří používají naše API, což je drtivá většina, je to okamžité.  
Pro ty, kteří používají naše denní exporty, je to D+1 za předpokladu, že jej aktualizují.

---

## Doplní nebo přepíše import dat ze záznamu produktu stávající záznam produktu?

Čárový kód používáme k identifikaci produktů. Pokud importujete záznam se stejným čárovým kódem jako existující záznam, informace se sloučí.

U údajů, jako je seznam složek, nutriční hodnoty (možná pouze jedna správná hodnota), data odeslaná prostřednictvím platformy výrobce přepíší stávající data.

U dat, jako jsou štítky/kategorie/značky (možných je několik správných hodnot), se informace sloučí. Pokud jsou data na veřejné platformě nesprávná, můžete upravit produktový list na veřejné platformě a odstranit nesprávné hodnoty.
...
## Mohu posílat obrázky také přes AGENA3000?

Obrázky můžete odesílat, ale v praxi bude automaticky vybrán pouze hlavní obrázek, ostatní obrázky budou odeslány, ale nebudou oříznuty / vybrány z hlediska složení, nutričních hodnot atd.

---

## Jak se dostanu k tutoriálům platformy Pro?

Tutoriály k platformě Pro si můžete prohlédnout:

- Prostřednictvím samotné platformy Pro: [https://world.pro.openfoodfacts.org/](https://world.pro.openfoodfacts.org/)

- Přímo na [YouTube](https://www.youtube.com/playlist?list=PLjAH-USadsF3xgSVfUUBS4we3XBr-1r55)

→ Můžete si také stáhnout naši [uživatelskou příručku](https://blog.openfoodfacts.org/en/EN-Pro-Plateform-User-Guide.pdf)
